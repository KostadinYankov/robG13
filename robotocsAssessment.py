...
class Follower: # create class
    ...
    def __init__(self): # initialisisation
        ...
        self.countSpin = 0
        # use the time to log the events
        self.timeHere=time()
        ...
        self.listOfPoints = [(2,-1),(3,0),(4,-4),(2,-4),(-2,-4),(-4,-5),(0.5,-0.2),(-1.5,3.5),(3,-1),(-1,2),(3,4),(-4,1.6),(-4,5),(-4,1),(-4,-2),(-1,-2)] # 10
    ...
    def generateMasks(self):
        ...
        # take away the circle in the middle of the screen
            ...
            if not self.searchObjects:
                ...
                if move['m00'] > 0 :
                    ...
                    if distanceToObject > 1.0 or numpy.isnan(distanceToObject):
                        ...
                        #self.goForwardAndAvoid(distanceToObject-0.5, 0)s
                        ...
                        elif not (colourAvgFilt[240,320] != 0) :
                    ...
                    elif distanceToObject < 1.0 or (move['m00']) < 1361000:
                        print('Object is now: {0}m away.'.format(distanceToObject))
